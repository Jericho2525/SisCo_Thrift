...
function MensCard({_id ,name,imageURL,description,stockQuantity ,price}) {
  ...
  >
    <h1 className="text-2xl ui-sans-serif mb-4">{name}</h1>
  ...
  <div className=""> <button className="bg-orange-400 p-2 rounded-full mt-2" onClick={() => addToCart(_id)}>
